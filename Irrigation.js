window.onload = async function() {
  ...
  baud.addEventListener('blur',()=>{baudValue = baud.value;})
    ...
    chzfarmed1 = document.getElementsByName('cropsChoose1');chzfarmed2 = document.getElementsByName('cropsChoose2')
...
for(;true;) {
  ...
  if(i++>=500){/*console.log(disp)*/;i=0;infoBoy(disp);disp=""}
  disp+=value;
...
function manualToggle(mnl){write("2"+"\n\n"+mnl+"\n\n");}
